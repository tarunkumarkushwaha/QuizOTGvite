...
const Navbar = () => {
  ...
  return (
    <>
      <header className="">
        <nav
          className={`${style.uiMode} absolute w-full top-0 z-10 px-8 md:px-auto min-h-20`}
        >
          <button
            className={`absolute top-5 left-4 h-8 w-8 md:hidden flex duration-200 ${menu ? "rotate-180" : "rotate-0"}`}
            onClick={changemenu}
          >
            ...
            <div className="flex md:flex-row flex-col justify-between items-center">
              ...
              <div className={`${style.text}`}>
                <ul className="flex font-semibold md:justify-between justify-center items-center md:flex-row flex-col gap-5">
                  <li
                    className={`${location.pathname == "/" ? "text-indigo-800" : `${style.text}`} hover:text-indigo-400`}
                  >
                  ...
                  {!accessToken && (
                    <>
                      <li
                        className={`${location.pathname == "/about" ? "text-indigo-800" : `${style.text}`} hover:text-indigo-400`}
                      >
                        <NavLink to="/about">About</NavLink>
                      </li>
                      <li
                        className={`${location.pathname == "/contact" ? "text-indigo-800" : `${style.text}`} hover:text-indigo-400`}
                      >
                  ...
                  {accessToken && (
                    <>
                      <li
                        className={`${location.pathname == "/testsetting" ? "text-indigo-800" : `${style.text}`} hover:text-indigo-400`}
                      >
                        <NavLink to="/testsetting">Setting</NavLink>
                      </li>
                      <li
                        className={`${location.pathname == "/result" ? "text-indigo-800" : `${style.text}`} hover:text-indigo-400`}
                      >
