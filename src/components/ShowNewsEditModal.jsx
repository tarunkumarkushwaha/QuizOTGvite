...
const ShowNewsEditModal = (props) => {
    const { onCancelClick, item, setpostitems, postitems, open, ...rest } = props;
    const [showEmojiModal, setshowEmojiModal] = useState(false);
    const cancelButtonRef = useRef(null);
    const [inputNews, setinputNews] = useState(item.post);
    const [file, setFile] = useState(item.imageSrc);
