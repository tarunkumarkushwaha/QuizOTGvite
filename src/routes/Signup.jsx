...
const Signup = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="bg-[url('/assets/mainbg.jpg')] bg-no-repeat bg-left to-green-200">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <Link to={"/termsandconditions"} className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</Link></label>
                  </div>
                </div>
